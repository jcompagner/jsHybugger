 ...
 */
public class SocketServer extends Thread implements DomainSocketServer {
     ...
     * @throws IOException 
     */
    public SocketServer(String domainSocketName, int forwarPort) throws IOException {
    	this.forwarPort = forwarPort;
    	this.domainSocketName = (domainSocketName != null ? domainSocketName : "jshybugger") + "_devtools_remote";

    	this.serverSocket = new ServerSocket(this.domainSocketName);			
